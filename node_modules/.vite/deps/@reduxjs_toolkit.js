...
// node_modules/@reduxjs/toolkit/node_modules/reselect/dist/reselect.legacy-esm.js
...
var getDevModeChecksExecutionInfo = (firstRun, devModeChecks) => {
  const { identityFunctionCheck, inputStabilityCheck } = __spreadValues2(__spreadValues2({}, globalDevModeChecks), devModeChecks);
  return {
...
function createSelectorCreator(memoizeOrOptions, ...memoizeOptionsFromArgs) {
  ...
  const createSelector2 = (...createSelectorArgs) => {
    ...
    const combinedOptions = __spreadValues2(__spreadValues2({}, createSelectorCreatorOptions), directlyPassedOptions);
    const {
      memoize,
      memoizeOptions = [],
