...
var printDocASTReducer = {
  ...
  FragmentDefinition: {
    leave: ({ name, typeCondition, variableDefinitions, directives, selectionSet }) => `fragment ${name}${wrap2("(", join(variableDefinitions, ", "), ")")} on ${typeCondition} ${wrap2("", join(directives, " "), " ")}` + selectionSet
  },
  IntValue: {
    leave: ({ value }) => value
  },
...
var host = maybe2(() => globalThis) || maybe2(() => global) || /* @__PURE__ */ Object.create(null);
var globalHost = host;
...
var QueryInfo = function() {
  ...
  QueryInfo2.prototype.setDiff = function(diff) {
    ...
    if (diff && !diff.complete && !((_a2 = this.observableQuery) === null || _a2 === void 0 ? void 0 : _a2.options.returnPartialData) && !(oldDiff && oldDiff.complete)) {
      return;
    }
...
function parser(document) {
  if (!cache) {
    cache = new AutoCleanedWeakCache(cacheSizes.parser || 1e3);
  }
